...
import com.mcg.aop.proxy.ByteBuddyProxyFactory;
...
public class ByteBuddyProxyTest {
    ...
    public static void main(String[] args) {
        ByteBuddyProxyFactory defaultAopProxyFactory=new ByteBuddyProxyFactory();
        Clazz c=new Clazz();
        ...
        Interface i=(Interface) aopProxy.getProxy(Thread.currentThread().getContextClassLoader());
        i.hello("world");
    }
