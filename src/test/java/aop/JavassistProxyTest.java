...
import com.mcg.aop.proxy.JavassistAopProxyFactory;
...
public class JavassistProxyTest {
    ...
    public static void main(String[] args) {
        JavassistAopProxyFactory javassistAopProxyFactory =new JavassistAopProxyFactory();
        Clazz c=new Clazz();
        ...
        AopProxy aopProxy= javassistAopProxyFactory.createAopProxy(config);
